      ...
      <main className="relative z-10 animate-fade-in pt-8">
        ...
        <section className="container mx-auto px-4 py-12 md:py-20">
          <div className="flex flex-col items-center text-center space-y-8 max-w-5xl mx-auto">
            <Badge className="glass-card px-4 py-2 text-sm font-medium text-foreground badge-pulse">
              <Sparkles className="h-4 w-4 mr-2 text-foreground icon-hover" />
              Powered by Advanced AI Technology
            </Badge>

            <div className="p-5 rounded-2xl glass-card animate-pulse-slow btn-float">
              <Activity className="h-20 w-20 text-primary icon-hover" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-12 w-full max-w-2xl">
              <div className="group relative">
                ...
                <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold text-primary gradient-text">95%</div>
              ...
              <div className="group relative">
                <div className="gradient-orb" />
                <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold text-primary gradient-text">10min</div>
              ...
              <div className="group relative">
                <div className="gradient-orb" />
                <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                  <div className="text-3xl font-bold text-primary gradient-text">24/7</div>
        ...
        <section id="features" className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <Badge className="glass-card px-4 py-2 mb-4 text-foreground badge-pulse">
              <Zap className="h-4 w-4 mr-2 text-foreground icon-hover" />
              Features
            </Badge>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="group relative stagger-item">
              <div className="gradient-orb" />
              <div className="glass-card-premium p-8 rounded-2xl space-y-4 hover:scale-105 transition-transform duration-300">
                <div className="p-4 rounded-xl bg-primary/10 w-fit group-hover:scale-110 transition-transform">
                  <Zap className="h-8 w-8 text-primary icon-hover" />
                </div>
            ...
            <div className="group relative stagger-item">
              ...
              <div className="glass-card-premium p-8 rounded-2xl space-y-4 hover:scale-105 transition-transform duration-300">
                <div className="p-4 rounded-xl bg-primary/10 w-fit group-hover:scale-110 transition-transform">
                  <Shield className="h-8 w-8 text-primary icon-hover" />
                </div>
            ...
            <div className="group relative stagger-item">
              ...
              <div className="glass-card-premium p-8 rounded-2xl space-y-4 hover:scale-105 transition-transform duration-300">
                <div className="p-4 rounded-xl bg-primary/10 w-fit group-hover:scale-110 transition-transform">
                  <Clock className="h-8 w-8 text-primary icon-hover" />
                </div>
            ...
            <div className="group relative stagger-item">
              ...
              <div className="glass-card-premium p-8 rounded-2xl space-y-4 hover:scale-105 transition-transform duration-300">
                <div className="p-4 rounded-xl bg-primary/10 w-fit group-hover:scale-110 transition-transform">
                  <Terminal className="h-8 w-8 text-primary icon-hover" />
                </div>
            ...
            <div className="group relative stagger-item">
              ...
              <div className="glass-card-premium p-8 rounded-2xl space-y-4 hover:scale-105 transition-transform duration-300">
                <div className="p-4 rounded-xl bg-primary/10 w-fit group-hover:scale-110 transition-transform">
                  <Gauge className="h-8 w-8 text-primary icon-hover" />
                </div>
            ...
            <div className="group relative stagger-item">
              ...
              <div className="glass-card-premium p-8 rounded-2xl space-y-4 hover:scale-105 transition-transform duration-300">
                <div className="p-4 rounded-xl bg-primary/10 w-fit group-hover:scale-110 transition-transform">
                  <CheckCircle2 className="h-8 w-8 text-primary icon-hover" />
                </div>
        ...
        <section id="how-it-works" className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <Badge className="glass-card px-4 py-2 mb-4 text-foreground badge-pulse">
              <TrendingUp className="h-4 w-4 mr-2 text-foreground icon-hover" />
              How It Works
            </Badge>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 gradient-text">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="relative">
              <div className="glass-card p-8 rounded-2xl space-y-4">
                <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary text-primary-foreground text-2xl font-bold badge-pulse">
                  1
                </div>
        ...
        <section id="benefits" className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <Badge className="glass-card px-4 py-2 mb-4 text-foreground badge-pulse">
              <Users className="h-4 w-4 mr-2 text-foreground icon-hover" />
              Benefits
            </Badge>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 gradient-text">
            ...
            <div className="glass-card p-6 rounded-xl flex gap-4">
              <div className="flex-shrink-0">
                <div className="p-3 rounded-lg bg-green-500/10">
                  <CheckCircle2 className="h-6 w-6 text-green-500 icon-hover" />
                </div>
              </div>
              <div>
            ...
            <div className="glass-card p-6 rounded-xl flex gap-4">
              <div className="flex-shrink-0">
                <div className="p-3 rounded-lg bg-blue-500/10">
                  <Clock className="h-6 w-6 text-blue-500 icon-hover" />
                </div>
              </div>
              <div>
            ...
            <div className="glass-card p-6 rounded-xl flex gap-4">
              <div className="flex-shrink-0">
                <div className="p-3 rounded-lg bg-purple-500/10">
                  <Cpu className="h-6 w-6 text-purple-500 icon-hover" />
                </div>
              </div>
              <div>
            ...
            <div className="glass-card p-6 rounded-xl flex gap-4">
              <div className="flex-shrink-0">
                <div className="p-3 rounded-lg bg-orange-500/10">
                  <HardDrive className="h-6 w-6 text-orange-500 icon-hover" />
                </div>
              </div>
              <div>
              ...
              <div className="col-span-2 md:col-span-1 space-y-4 mb-4 md:mb-0">
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-lg bg-primary/10">
                    <Activity className="h-5 w-5 md:h-6 md:w-6 text-primary icon-hover" />
                  </div>
                  <div>
